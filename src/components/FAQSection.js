            ...
            <div className="container">
                <div className="flex flex-col md:flex-row gap-24 justify-between items-center">
                    <div className="text-white">
                        <h2 className="font-bold text-3xl md:text-5xl mb-2">Clarity before commitment.</h2>
                        <p className="text-lg ">Explore direct answers about scope, technology, timelines, ownership, and working together.</p>
                    </div>
                    <div>
