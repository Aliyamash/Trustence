        ...
        <div className="bg-transparent py-64">
            <div className="container">
                <div className="text-center">
                    ...
                    <p className="text-xl md:text-2xl font-bold md:mx-24 mb-24 text-white">In this free session, we help you clarify your true business goals, identify your challenges, and craft a clear digital roadmap to achieve success.</p>
