    ...
    return(
        <div className="bg-white py-64">
            <div className="container">
                <div className="mb-24">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold  text-center">Our Core Principles</h2>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-16">
                    <div className="text-center text-black text-pretty">
                            <h3 className="text-2xl md:font-bold title mb-4">Client-Centric</h3>
                    ...
                    <div className="text-center text-black text-pretty">
                            <h3 className="text-2xl md:font-bold title mb-4">Performance-Driven</h3>
                    ...
                    <div className="text-center text-black text-pretty">
                            <h3 className="text-2xl md:font-bold title mb-4">Continuous Engagement</h3>
